...
function parseData(data, oneDayData, twoDayData, oneWeekData, ethPrice, oneDayBlock) {
  ...
  if (data?.token0?.id === '0x0C0488a2e3f5FdEb482Bf5A76AB1ef27A3658101') {
    data.token0.name = 'Ether (Wrapped)'
    data.token0.symbol = 'ETH'
  }
  if (data?.token1?.id === '0x0C0488a2e3f5FdEb482Bf5A76AB1ef27A3658101') {
...
/**
 * Get list of all pairs in Materia
 */
