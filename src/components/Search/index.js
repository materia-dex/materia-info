...
import { useAllPairsInMateria, useAllTokensInMateria } from '../../contexts/GlobalData'
...
export const Search = ({ small = false }) => {
  let allTokens = useAllTokensInMateria()
  const allTokenData = useAllTokenData()

  let allPairs = useAllPairsInMateria()
              ...
              : below410
                ...
                : below470
                  ...
                  : below700
                    ...
                    : 'Search Materia pairs and tokens...'
          }
          value={value}
          onChange={(e) => {
                ...
                <BasicLink to={'/pair/' + pair.id} key={pair.id} onClick={onDismiss}>
                  <MenuItem>
                    ...
                    <TYPE.body style={{ marginLeft: '10px' }}>
                      {pair.token0.isymbol + '-' + pair.token1.isymbol} Pair
                    </TYPE.body>
                  </MenuItem>
                </BasicLink>
              )
              ...
              <BasicLink to={'/token/' + token.id} key={token.id} onClick={onDismiss}>
                <MenuItem>
                  <RowFixed>
                    ...
                    <FormattedName text={token.iname} maxCharacters={20} style={{ marginRight: '6px' }} />
                    (<FormattedName text={token.source === " " ? token.isymbol : (token.isymbol + "/" + token.symbol)} maxCharacters={18} />)
                  </RowFixed>
                </MenuItem>
              </BasicLink>
            )
